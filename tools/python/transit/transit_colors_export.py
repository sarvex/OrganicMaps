...
if __name__ == '__main__':
    ...
    default_colors_path = f'{os.path.dirname(os.path.abspath(__file__))}/../../../data/colors.txt'
    parser.add_argument('in_out_file', nargs='?', type=str, default=default_colors_path,
                        help='path to colors.txt file')
    default_transits_colors_path = f'{os.path.dirname(os.path.abspath(__file__))}/../../../data/transit_colors.txt'
